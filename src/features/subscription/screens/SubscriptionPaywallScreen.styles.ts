...
export const styles = StyleSheet.create({
  ...
  heroContent: { position: 'absolute', left: 14, right: 14, bottom: 10 },
  heroTitle: {
  ...
  // PLANES (base)
  // =========================
  plansSection: { paddingTop: 2, paddingBottom: 12 },
  plansTitle: {
  ...
  ctaFade: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 64 },
  ctaButton: {
    height: 44,
    borderRadius: 14,
